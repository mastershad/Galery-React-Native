...
VESDK.unlockWithLicense(require("./pesdk_license"));
      ...
      <SafeAreaView>
        <ScrollView
          ...
          <Button title="Edit a sample image" onPress={() => {
            PESDK.openEditor(require("./image.jpg"), configuration, serialization).then(result => {
              if (result != null) {
          ...
          <Button title="Edit a sample video" onPress={() => {
            VESDK.openEditor(require("./video.mp4"), configuration, serialization).then(result => {
              if (result != null) {
                serialization = result.serialization;
              }
            });
